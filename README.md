...
* **Cloud & DevOps:** AWS (EC2, S3, VPC, IAM, ALB, CodeDeploy, CloudWatch)
* **Containers & Orchestration:** Docker, Kubernetes, GitHub Actions, DockerHub
* **Languages & Linux OS:** Python, Flask, Bash, YAML, Ubuntu, Fedora

---

## 📬 Let's Connect

I'm open to **DevOps Engineer**, **Cloud Infrastructure**, and **Systems Performance** engineering roles. If you're building resilient cloud architectures or looking at low-level compute constraints, let's talk.
